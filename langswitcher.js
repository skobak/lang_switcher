...
(function () {
    ...
    /*functions*/
    var getActualLanguage, getCookie, setCookie;
    /* Post-Soviet states ISO-codes*/
    var ru_speakers_iso_codes = ['RU', 'UA', 'BY', 'AM', 'AZ', 'BY', 'EE', 'GE', 'KZ', 'KG', 'LV', 'LT', 'MD', 'TJ', 'TM', 'UZ'];
    ...
    if (!getCookie('langDetected')) {
        ...
        language_needed = getActualLanguage(language.toLocaleUpperCase());
